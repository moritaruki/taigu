const APP_CACHE='taigi2500-v1-c2-20260921';
const ASSETS=['./','./index.html','./data.js','./extended-words.js','./sentences.js','./sentences-extra.js','./audio-map.js','./audio.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
